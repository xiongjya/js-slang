...
function peg$parse(input, options) {
  ...
  var peg$FAILED = {},
      ...
      peg$c144 = "chan",
      peg$c145 = peg$literalExpectation("chan", false),
      peg$c146 = "const",
      ...
      peg$c158 = "func",
      peg$c159 = peg$literalExpectation("func", false),
      peg$c160 = "go",
      peg$c161 = peg$literalExpectation("go", false),
      peg$c162 = "goto",
      peg$c163 = peg$literalExpectation("goto", false),
      peg$c164 = "if",
      peg$c165 = peg$literalExpectation("if", false),
      peg$c166 = "import",
      peg$c167 = peg$literalExpectation("import", false),
      peg$c168 = "new",
      peg$c169 = peg$literalExpectation("new", false),
      peg$c170 = "nil",
      peg$c171 = peg$literalExpectation("nil", false),
      peg$c172 = "range",
      peg$c173 = peg$literalExpectation("range", false),
      peg$c174 = "return",
      peg$c175 = peg$literalExpectation("return", false),
      peg$c176 = "select",
      peg$c177 = peg$literalExpectation("select", false),
      peg$c178 = "struct",
      peg$c179 = peg$literalExpectation("struct", false),
      peg$c180 = "switch",
      peg$c181 = peg$literalExpectation("switch", false),
      peg$c182 = "true",
      peg$c183 = peg$literalExpectation("true", false),
      peg$c184 = "type",
      peg$c185 = peg$literalExpectation("type", false),
      peg$c186 = "var",
      peg$c187 = peg$literalExpectation("var", false),
      peg$c188 = "bool",
      peg$c189 = peg$literalExpectation("bool", false),
      peg$c190 = "string",
      peg$c191 = peg$literalExpectation("string", false),
      peg$c192 = "int",
      peg$c193 = peg$literalExpectation("int", false),
      peg$c194 = "uint",
      peg$c195 = peg$literalExpectation("uint", false),
      peg$c196 = "byte",
      peg$c197 = peg$literalExpectation("byte", false),
      peg$c198 = "float32",
      peg$c199 = peg$literalExpectation("float32", false),
      peg$c200 = "float64",
      peg$c201 = peg$literalExpectation("float64", false),
      peg$c202 = "WaitGroup",
      peg$c203 = peg$literalExpectation("WaitGroup", false),
      peg$c204 = ";",
      ...
      peg$c212 = function(expression) { return expression; },
      peg$c213 = function(elision) {
            return {
              type: "ArrayExpression",
              elements: optionalList(extractOptional(elision, 0))
            };
          },
      peg$c214 = function(elements) {
            return {
              type: "ArrayExpression",
              elements: elements
            };
      ...
      peg$c217 = function(elements, elision) {
            return {
              type: "ArrayExpression",
              elements: elements.concat(optionalList(extractOptional(elision, 0)))
            };
          },
      peg$c218 = function(elision, element) {
              return optionalList(extractOptional(elision, 0)).concat(element);
            },
      peg$c219 = function(head, elision, element) {
              return optionalList(extractOptional(elision, 0)).concat(element);
            },
      peg$c220 = function(head, tail) { return Array.prototype.concat.apply(head, tail); },
      peg$c221 = function(commas) { return filledArray(commas.length + 1, null); },
      peg$c222 = "{",
      peg$c223 = peg$literalExpectation("{", false),
      peg$c224 = function() { return { type: "ObjectExpression", properties: [] }; },
      peg$c225 = function(properties) {
      ...
      peg$c235 = function(callee) {
            return { type: "NewExpression", callee: callee, arguments: [] };
          },
      peg$c236 = function(func) {
          return {
            ...func,
            type: "GoRoutine"
          }
        },
      peg$c237 = function(callee, args) {
              return { type: "CallExpression", callee: callee, arguments: args };
            },
      peg$c238 = function(head, args) {
      ...
      peg$c259 = function(head, tail) { return buildBinaryExpression(head, tail); },
      peg$c260 = "**",
      ...
      peg$c302 = function(head, tail) { return buildLogicalExpression(head, tail); },
      peg$c303 = "&&",
      ...
      peg$c309 = function(test, consequent, alternate) {
            return {
      ...
      peg$c337 = function(body) {
            return {
              type: "BlockStatement",
              body: optionalList(extractOptional(body, 0))
            };
          },
      peg$c338 = function(head, tail) { return buildList(head, tail, 1); },
      peg$c339 = function(declarations) {
            return {
      ...
      peg$c340 = function(declarations) {
            return {
      ...
      peg$c341 = function(ids, type, init) {
      	  return {
              ids: ids,
      ...
      peg$c346 = function(expr) {
         return expr;
        },
      peg$c347 = function(id, init) {
            return {
      ...
      peg$c352 = function(init, test, update, body) {
            return {
              type: "ForStatement",
      ...
      peg$c353 = function(declarations, test, update, body) {
            return {
              type: "ForStatement",
              init: {
                type: "VariableDeclaration",
      ...
      peg$c360 = function(discriminant, cases) {
            return {
      ...
      peg$c361 = function(clauses) {
            return optionalList(extractOptional(clauses, 0));
          },
      peg$c362 = function(before, default_, after) {
      ...
      peg$c365 = function(label, body) {
            return { type: "LabeledStatement", label: label, body: body };
          },
      peg$c366 = function(id, params, type, body) {
            return {
  ...
  function peg$parseGoRoutineExpression() {
    var s0, s1, s2, s3;
  ...
  function peg$parseDeclarationTypeSpecification() {
    var s0, s1, s2, s3, s4, s5, s6;
  ...
  function peg$parseDeclarationSpecification() {
    var s0, s1, s2, s3;
  ...
  function peg$parseShortVariableStatement() {
    var s0, s1, s2, s3, s4, s5, s6;
