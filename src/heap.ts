...
export default class Heap {
  reset_string_pool() {
    ...
    heap_get(address: any) { return this.HEAP.getFloat64(address * word_size) }

    heap_set(address: any, x: any) { return this.HEAP.setFloat64(address * word_size, x) }

    // child index starts at 0
    heap_get_child(address: any, child_index: any) { return this.heap_get(address + 1 + child_index) }

    heap_set_child(address: any, child_index: any, value: any) {
        return this.heap_set(address + 1 + child_index, value)
    }
    
    heap_get_tag(address: any) { return this.HEAP.getUint8(address * word_size) }

    heap_get_size(address: any): number { return this.HEAP.getUint16(address * word_size + size_offset) }
...
is_False(address: any) { return this.heap_get_tag(address) === Heap.False_tag }

True = this.heap_allocate(Heap.True_tag, 1)
is_True(address: any) { return this.heap_get_tag(address) === Heap.True_tag }

is_Boolean(address: any) { return this.is_True(address) || this.is_False(address) }

Null = this.heap_allocate(Heap.Null_tag, 1)
is_Null(address: any) { return this.heap_get_tag(address) === Heap.Null_tag }

Unassigned = this.heap_allocate(Heap.Unassigned_tag, 1)
is_Unassigned(address: any) { return this.heap_get_tag(address) === Heap.Unassigned_tag}

Undefined = this.heap_allocate(Heap.Undefined_tag, 1)
is_Undefined(address: any) { return this.heap_get_tag(address) === Heap.Undefined_tag }
...
is_String(address: any) : boolean { return this.heap_get_tag(address) === Heap.String_tag }
...
heap_get_string_hash(address: any) { return this.heap_get_4_bytes_at_offset(address, 1) }

heap_get_string(address: any) { return this.stringPool[this.heap_get_string_hash(address)][1] }

// builtins: builtin id is encoded in second byte
// [1 byte tag, 1 byte id, 3 bytes unused,
//  2 bytes #children, 1 byte unused]
// Note: #children is 0
is_Builtin (address: any) { return this.heap_get_tag(address) === Heap.Builtin_tag }
...
heap_get_Builtin_id(address: any) { return this.heap_get_byte_at_offset(address, 1) }
...
heap_get_Closure_arity(address: any) { return this.heap_get_byte_at_offset(address, 1) }

heap_get_Closure_pc(address: any) { return this.heap_get_2_bytes_at_offset(address, 2) }

heap_get_Closure_environment(address: any) { return this.heap_get_child(address, 0) }

is_Closure(address: any) { return this.heap_get_tag(address) === Heap.Closure_tag }
...
heap_get_Blockframe_environment(address: any) { return this.heap_get_child(address, 0) }

is_Blockframe(address: any) { return this.heap_get_tag(address) === Heap.Blockframe_tag }
...
heap_get_Callframe_environment(address: any) { return this.heap_get_child(address, 0) }

heap_get_Callframe_pc(address: any) { return this.heap_get_2_bytes_at_offset(address, 2) }

is_Callframe(address: any) { return this.heap_get_tag(address) === Heap.Callframe_tag }
...
heap_empty_Environment() { return this.heap_allocate_Environment(0) }
...
is_Number(address: any) : boolean { return this.heap_get_tag(address) === Heap.Number_tag }

static is_boolean(x: any): boolean { return typeof x === 'boolean' }

static is_number(x: any): boolean { return typeof x === 'number' }

static is_null(x: any): boolean { return x === null }

static is_string(x: any): boolean { return typeof x === 'string' }

static is_undefined(x: any): boolean { return x === undefined }
